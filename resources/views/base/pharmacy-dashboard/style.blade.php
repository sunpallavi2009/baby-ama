<style type="text/css">
    ...
    #sidebar-wrapper {
        box-shadow: 4px 4px 8px 0px rgba(178, 186, 198, 0.08);
    }

    .header {
        background: #FFF;
        box-shadow: 0px 4px 8px 0px rgba(178, 186, 198, 0.08) !important;
    }

    .sidebar-nav .sidebar-link.has-child {
        border-radius: 2px;
        background: rgba(138, 79, 186, 0.10);
    }

    .sidebar-nav .sidebar-link.has-child .sub-menu li a {
        color: #667085;
        font-size: 14px;
        line-height: 40px;
        font-weight: 500;
    ...
    .sidebar-nav .sidebar-link.has-child .sub-menu li:hover,
    .sidebar-nav .sidebar-link.has-child .sub-menu li.active {
        border-radius: 2px;
        background: rgba(138, 79, 186, 0.10);
    }
...
<style>
    ...
    .prescription-table .table tbody tr {
    ...
    .prescription-table .table thead tr th:not(:nth-child(1)) {
        min-width: 80px;
    }
    ...
    .prescription-table .table thead tr th:nth-child(9) {
        min-width: 125px;
    }
...
<style>
    ...
    .pharmacy .med-search-container .med-search {
        min-width: unset;
    }
    ...
    .pharmacy .style-one .form-field,
    .pharmacy .field-with-suffix .form-field {
    ...
    .prescription-table .table thead tr th.action-btn {
        min-width: 70px;
    }

    .prescription-table .table thead tr th.date {
        min-width: 115px;
    }

    .prescription-table .table thead tr th.p-name {
        min-width: 200px;
    }
    ...
    .table-responsive::-webkit-scrollbar-track {
        background-color: rgba(127, 86, 217, 0.35);
        border-radius: 10px;
    }
    ...
    .act-btn.warning:hover {
        ...
        color: #fff;
        box-shadow: rgba(255, 43, 55, 0.15) 0px 2px 8px
    }
    ...
    .act-btn.success:hover {
        ...
        color: #fff;
        box-shadow: rgba(77, 177, 87, 0.15) 0px 2px 8px
    }
    ...
    .pharma-btn.primary:hover {
        ...
        background-color: #8A4FBA;
        color: #fff;
        box-shadow: rgba(138, 79, 186, 0.35) 0px 2px 8px
    }
    ...
    .invoice-table table tr td.tf-info {
        /* text-align: right; */
    }

    .invoice-table table tbody::after {
        line-height: 0.5em;
        content: ".";
        visibility: hidden;
        color: white;
    ...
    .invoice-table table tfoot:before {
        line-height: 2em;
        content: ".";
        visibility: hidden;
        color: white;
    ...
    @media (min-width: 992px) {
        .modal-edit-medicine .modal-dialog {
            max-width: 992px;
        }
