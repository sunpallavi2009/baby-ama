...
<style>
    ...
    .patient-info p span.val {
        width: calc(100% - 74px);
        display: inline-block;
    }

    .patient-info p span.label::after {
        content: ":";
        position: absolute;
        top: 0;
        bottom: 0;
...
<style>
    ...
    .field-with-suffix .form-label::after {
        content: ' : ';
        position: absolute;
        right: 2px;
        top: 4px;
    ...
    .input-with-checkbox .input-lbl::after {
        content: ':';
        position: absolute;
        top: 50%;
        transform: translateY(-50%);
    ...
    .reports-gallery .report .report-info .info {
        width: calc(100% - 18px);
    }

    .reports-gallery .report .report-info .actions {
        width: 10px;
    }
    ...
    .rounded-checkbox {
        box-shadow: 0px 0px 3px 0.5px #00000024 inset;
        width: 30px;
        height: 30px;
        border-radius: 50%;
        overflow: hidden;
    ...
    .rounded-checkbox.checked .form-label {
        background-color: #9747FF;
        color: white;
    }

    .sound-teeth .accordion-button:not(.collapsed) {
        color: #8A4FBA;
        background-color: transparent;
        box-shadow: none;
    }

    .rounded-checkbox .form-label {
        background-color: transparent;
        color: #00000024;
