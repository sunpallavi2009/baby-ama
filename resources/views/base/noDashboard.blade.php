    ...
    <script>
        $(document).ready(function() {
            ...
            $(".form-check").each(function() {
                if ($(this).is(":checked")) {
                    $(this).parent(".rounded-checkbox").addClass("checked");
                }
            });

            // When any checkbox input with the class "form-check" is changed
            $(".form-check").change(function() {
                // If it is checked
                if ($(this).is(":checked")) {
                    // Add the class "checked" to its parent div with the class "rounded-checkbox"
                    $(this).parent(".rounded-checkbox").addClass("checked");
                } else {
                    // If it is unchecked, remove the class "checked" from its parent div
                    $(this).parent(".rounded-checkbox").removeClass("checked");
                }
            });
            ...
            function addNewProcedure() {
                const newprd = $('<tr></tr>');
                const dateVisited = $('<td></td>').addClass('text-center date').html(`
                    <div class="d-flex justify-content-center align-items-center">
                        <input class="form-control" type="date" name="visited_date[]" value="<?php echo date('Y-m-d'); ?>">
                        <div>
                        </div>
                    </div>
                `);
                ...
                `);
                newprd.append(dateVisited, adviceCell, dateCell);
