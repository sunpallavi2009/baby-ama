        ...
        <form action="{{ route('doctor.patient.women_wellness.post', $patient->id) }}" method="POST">
            ...
            <div class="row py-5 my-5 mx-0 pediatric-form-fields ">
                ...
                <div id="" class="col-12 col-lg-8 col-xl-7 "> <label for="objective_label"
                        class="mt-5 pt-5 mb-4">OBJECTIVE </label>

                    </div>

                        <div class="col-md-9 p-2">
                        <label for="objective_label"
                        class="mt-5 pt-5 mb-4">On Observation </label>
                              <label for="women_wellness_observation_built"
                            class="form-label">Built </label> <textarea rows="" class="form-control"
                ...
                <div class="col-md-9 p-2"><label for="women_wellness_onvestogatopms"
                            class="form-label">Investigations if any  </label> <textarea rows="" class="form-control"
                ...
                <div class="col-md-9 p-2">
                    <label for="women_wellness_diagnosis" class="form-label"> Diagnosis </label> <textarea rows=""  class="form-control"
                id="women_wellness_diagnosis" name="women_wellness_diagnosis" ><?php if (isset($get->women_wellness_diagnosis)) { echo $get->women_wellness_diagnosis;} ?></textarea>
            </div>
            <div class="col-md-9 p-2">
                <label for="women_wellness_management" class="form-label">Management </label> <textarea rows=""  class="form-control"
            id="women_wellness_management" name="women_wellness_management" ><?php if (isset($get->women_wellness_management)) { echo $get->women_wellness_management;} ?></textarea>
        </div>
                <div class="col-md-9 p-2">
            ...
            {{-- <div class="col-12 d-none col-md-3 col-lg-4 col-xl-5">
