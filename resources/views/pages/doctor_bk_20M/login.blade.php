         ...
         <div class="text-center">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <form method="POST" action="{{ route('doctor.login.post') }}" class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
                         @csrf
                         ...
                         <!--begin::Heading-->
                             ...
                             <div class="fv-row mb-10">
                                 ...
                                 <input class="form-control form-control-lg form-control-solid" id="password" type="password" name="password" placeholder="Your password" autocomplete="off" value="{{ old('password') }}" required />
                             ...
                             <div class="fv-row mb-10">
                               <a href="{{ route('doctor.forgot') }}"><label class="form-label float-start fs-6 fw-bolder text-dark">Forgot Password ?</label>
                               </a>
                            </div>
                            <br>
                            <br>
