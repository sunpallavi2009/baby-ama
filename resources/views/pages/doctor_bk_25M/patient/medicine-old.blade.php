                        ...
                        <div class="table-responsive py-3 w-5" id="mydiv">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $fullName =helperFormatMedicinePrefix($list_medicine->type).'
                                    '.$list_medicine->name.$getType;
                                    @endphp
                                    <tr>
                                        ...
                                        <td class="">({{helperFormatMedicinePrefix($list_medicine->type)}})
                                            ...
                                            {{'('.$list_medicine->dosage.')'}} @endif
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex">
                                                <div class="w-50 d-flex justify-content-center align-items-center">
                                                    <button class="action-btn" data-bs-toggle="modal"
                                                        data-bs-target="#EditMedPopModal"
                                                        onclick="editMedicine('<?php echo $list_pres->id; ?>');">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="">
                                            ...
                                            <div class="row justify-content-between align-items-center mx-0">
                                                <div class="col-6 form-fl px-1">
                                                    ...
                                                    <input type="number" class="form-control rounded-0" placeholder="0"
                                                        id="intake_dosage_{{$medicine1->id}}" name="intake_qty" value=""
                                            ...
                                            <div class="row mx-0">
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="TMorning" name="timing_when[]"
                                                            value="Morning">
                                                ...
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="Tafternoon" name="timing_when[]"
                                                            value="Noon">
                                                ...
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="Tevening" name="timing_when[]"
                                                            value="Night">
                                    ...
                                    <div class="row mx-0 mb-4 align-items-center">
                                      ...
                                      --> <input type="number" class="form-control rounded-0" placeholder="0"
                                                        id="totaldays_{{$medicine1->id}}" name="tab_count_days" step="1"
                                                        min="1"
                                        ...
                                        <div class="col-8">
                                            <div class="row mx-0 align-items-center">
                                                <div class="col-6 px-1 form-fld">
                                                    <span class="me-2" id="total_cnt_{{$medicine1->id}}">0</span>
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <button type="submit" class="baby-primary-btn border-1" id="btn_{{$medicine1->id}}">Add</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Start Edit Medicine Modal -VG -->
            ...
            <div class="col-12">
                <div class="modal fade med-data-modal" id="EditMedPopModal" tabindex="-1"
                    aria-labelledby="MedPopModalLabel" aria-hidden="true">
    <form action="{{route('doctor.appointment.patient.prescription.medicine.post',['appoinment'=>$appoinment->id,'patient'=>$user->patient->id])}}" method="POST">
            @csrf
            <input type="hidden" name="pr_id" id="edit_pr_id" value="">
                        ...
                        <div class="modal-content">
                            <div class="modal-header py-4">
                                <h3 class="modal-title fs-5 text-center med-name w-100" id="MedPopModalLabel">
                                    <span class="me-2">Medicine Name</span>
                                </h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
        ...
        <div class="row justify-content-between align-items-center mx-0">
        <div class="col-6 form-fl px-1">
            <input type="number" class="form-control rounded-0" placeholder="0"  id="edit_intake_dosage" name="intake_qty" value="" onchange="edit_dosage_incnt(this.value)" step="1" min="1">
        </div>
        <div class="col-5 form-fl px-1">
                                                    <!-- <input type="text" class="form-control rounded-0" placeholder="Tab"
                                                    id="insReportName" name="tab_name" value="" disabled> -->
        <select class="form-control rounded-0" name="dosage" id="edit_dosage"
                                    onchange="dosagein(this.value)">
            <option value="Tablet">Tablet</option>
            <option value="Ml"> Ml</option>
        </select>
        </div>
                                    ...
                                    <div class="row mx-0 mb-4 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <div class="row mx-0">
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="edit_TMorning" name="timing_when[]"
                                                            value="Morning">
                                                        <label for="TMorning">Morning</label>
                                                    </div>
                                                </div>
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="edit_Tafternoon" name="timing_when[]"
                                                            value="Noon">
                                                        <label for="Tafternoon">Noon</label>
                                                    </div>
                                                </div>
                                                <div class="col-4 px-1">
                                                    <div class="select-chk">
                                                        <input type="checkbox" id="edit_Tevening" name="timing_when[]"
                                                            value="Night">
                                                        <label for="Tevening">Night</label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mx-0 mb-4 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <div class="row mx-0">
                                                <div class="col-6 px-1">
                                                    <div class="select-chk">
                                        <input type="radio" id="edit_timing_how_bf" name="timing_how[]" value="beforefood">
                                                        <label for="bfood">Before Food</label>
                                                    </div>
                                                </div>
                                                <div class="col-6 px-1">
                                                    <div class="select-chk">
                                            <input type="radio" id="edit_timing_how_af" name="timing_how[]" value="afterfood">
                                                        <label for="food">After Food</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mx-0 mb-4 align-items-center">
                                      ...
                                      --> 
    <input type="number" class="form-control rounded-0" placeholder="0"
       id="edit_totaldays" name="tab_count_days" step="1" min="1"
    onchange="followUpDays(this.value')">
                                                </div>
                                                <div class="col-6 px-1">
                                                    <label for="FollowUpDays">Days</label>
                                                </div>
                                    ...
                                    <div class="row mx-0 mb-4 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <div class="row mx-0 align-items-center">
                                                <div class="col-6 px-1 form-fld">
                                                    <span class="me-2" id="edit_total_cnt">0</span>
                                                    <span id="edit_total_dg"></span>
                                                    <input type="hidden" name="total_qty"
                                                        id="edit_total_qty" value="5">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer border-0">
                                <button type="button" class="baby-secondary-btn border-1"
                                    data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="baby-primary-btn border-1" id="btn_{{$medicine1->id}}">Update</button>
                            </div>
                        </div>
            </div>
    </form>
