...
<section class="doctor-patinet-appointment pt-5">
    ...
    <div class="prescrioption-form" style="margin-top:50px">
        ...
        <form
            action="{{route('doctor.appointment.prescription.edit.post',['appoinment'=>$appoinment->id,'patient'=>$user->patient->id,'type' => $get['type']])}}"
            method="POST">
            @csrf
                ...
                <div class="col-md-8">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-12 col-md-10 pb-5" >
                            <div class="prescription-field-area mb-5">
                                <label for="prescription_date">Date</label>
                                <input class="form-control" type="date" id="prescription_date" name="prescription_date">
                            </div>
                            <div class="prescription-field-area mb-5">
                                <label for="prescription_type">Select Type</label>
                            ...
                            <div class="prescription-field-area mb-4">
                                ...
                                <textarea class="form-control" name="follow_up_advice"
                                    id="follow_up_advice">{{isset($data->follow_up_advice) ? $data->follow_up_advice : old('follow_up_advice')}}</textarea>
                                @if($errors->has('follow_up_advice'))
                                <span class="text-danger error">{{ $errors->first('follow_up_advice') }}</span>
                                @endif
                            </div>
