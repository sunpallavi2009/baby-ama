    ...
    <div class="page-content " style="padding-top:60px;">
        ...
        <section class="clinical-notes py-4">
           ...
           // print_r($data);
                    ...
                    <div class="clinical-note baby-border mb-5">
                        <div class="row px-5 py-4 align-items-center justify-content-between mb-4">
                            ...
                            <div class="notes py-2">
                                ...
                                <?php
                                    $prescription_medicine = DoctorPrescriptionMedicine::where(['prescription_id'=>$ps['id'],'appointment_id'=>$ps['appointment_id'],'type'=>'women_wellness'])->get();
                                ?>
            ...
            <?php
            $data = isset($cn['women_wellness']) ? json_decode($cn['women_wellness']) : [];
            ...
            <?php
        $prescription_medicine = DoctorPrescriptionMedicine::where(['prescription_id'=>$ps['id'],'appointment_id'=>$data->id,'type'=>'women_wellness'])->get();
    ?>
            @if (isset($prescription_medicine))
            <div class="prescription-table py-3">
                <h3 class="">Drug and Prescription</h3>
