                        ...
                        <div class="row">
                            ...
                            <div class="col form-fld">
                                {{-- <input type="text"
                                    ...
                                    <select id="report_type" name="report_type" class="form-select" aria-label="select type" required>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 p-3">
                            <div class="report">
                                ...
                                <div class="report-info p-3">
                                    <div class="info">
                                        <p class="r-name mb-1">{{ Str::ucfirst($getreports->report_name) }}</p>
                                        <p class="r-name mb-1">{{ Str::ucfirst($getreports->report_type) }}</p>
                                    ...
                                    <div class="actions">
                                        <div class="dropdown dropstart">  {{-- dropup dropup-center  --}}
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#reporEdit"  data-id="{{ $getreports->id }}" onclick="editFunc(<?php echo  $getreports->id; ?>)">Edit</button></li>
                                                <li><button class="dropdown-item report_class" type="button" data-bs-toggle="modal" data-bs-target="#reporDelete" data-id="{{ $getreports->id }}" onclick="delFunc({{ $getreports->id }})">Delete</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="reportenlargeLabel">Update Report</h1>
...
var actionUrl = "{{ route('doctor.patient.search.editReport', ':p_id') }}";
actionUrl = actionUrl.replace(':p_id', p_id);
