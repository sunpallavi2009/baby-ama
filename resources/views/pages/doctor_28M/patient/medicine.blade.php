...
@section('doctor-content')
        ...
        <div class="row" style="margin-top:50px;">
                    ...
                    <div class="med-search-result py-4 mt-4">
                        ...
                        <div class="med-items">
                            @foreach ($medicines as $medicine)
                                @php
                                    $getType = isset($medicine->dosage) ? ' (' . $medicine->dosage . ')' : '';
                                    $fullName =
                                        helperFormatMedicinePrefix($medicine->type) . ' ' . $medicine->name . $getType;
                                @endphp
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pres as $list_pres)
                                            @php
                                                ...
                                                $getType = isset($list_medicine->dosage)
                                                    ? ' (' . $list_medicine->dosage . ')'
                                                    : '';
                                                    $typ= (isset($list_medicine->type))
                                                    ? helperFormatMedicinePrefix($list_medicine->type) : '';

                                                    $lname= (isset($list_medicine->name))
                                                    ? helperFormatMedicinePrefix($list_medicine->name) : '';
                                                $fullName = $typ.''.$lname .$getType;
                                            @endphp
                                            <tr>
            ...
            @foreach ($pres as $list_pres1)
                @php
                    ...
                    $getType1 = isset($list_medicine1->dosage) ? ' (' . $list_medicine1->dosage . ')' : '';
                    $lname1 = isset($list_medicine1->name) ? ' (' . $list_medicine1->name . ')' : '';

                    $fullName =
                        helperFormatMedicinePrefix($getType1) . '' . $lname1. $getType1;
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header py-4">
                                        <h3 class="modal-title fs-5 text-center med-name w-100" id=" MedPopModalLabel">
                                            @php
                                        $getType1 = isset($list_medicine1->type) ? ' (' . $list_medicine1->type . ')' : '';
                                        $lname1 = isset($list_medicine1->name) ? ' (' . $list_medicine1->name . ')' : '';

                                            @endphp
                                            <span
                                                class="me-2">({{ helperFormatMedicinePrefix($getType1) }})</span>
                                            {{ $lname1 }}
                                            <span class="ms-2">({{ $medicine1->dosage }})</span>
                                        </h3>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
    ...
    <!-- Add New Med Modal -->
    <div class="modal fade" id="addnewdsMed" tabindex="-1" aria-labelledby="addnewdsMedLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
