...
<div class="page-content " style="padding-top:60px;">
    <div class="add-new-prescription-btn">
        <a class="baby-add-new-btn"
            href="{{route('doctor.appointment.patient.prescription.add',['appoinment'=>$appoinment->id,'patient'=>$user->patient->id])}}">
    ...
    <section class="clinical-notes py-4">
        ...
        <div class="clinical-note baby-border mb-5">
            <div class="row px-5 py-4 align-items-center justify-content-between mb-4">
                <div class="col-6 px-0"><p class="mb-0 date h6"></p></div>
                ...
                <div class="row px-5 py-4 align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="patient-info">
                            ...
                            <p class="doctor-patinet-app-list-color"><span class="fw-normal label">Gender</span><span class="val">{{$user->patient->gender}}</span></p>
                            <p class="doctor-patinet-app-list-color"><span class="fw-normal label">Age</span><span class="val">{{$user->patient->age}}</span></p>
                            @endif
                    ...
                    <div class="col-12 col-md-4">
                        <div class="patient-info">
                            ...
                            <p class="doctor-patinet-app-list-color"><span class="fw-normal label">Doctor </span><span class="val">{{$appoinment->doctor->first_name.'
                                '.$appoinment->doctor->last_name}}</span></p>
                            @endif
            ...
            <div class="notes py-2">
                ...
                <div class="summary mb-2">
                    <p class="question">Treatments</p>
                    <p class="answer border-0">
                        @php echo isset($ps->treatments) ? $ps->treatments : '-Nil-'; @endphp
                    </p>
                </div>
                <div class="summary mb-2">
                    <p class="question">Follow up days</p>
                    <p class="answer border-0">
                        @php echo isset($ps->follow_up_days) ? $ps->follow_up_days : '-Nil-'; @endphp
                    </p>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$p_medicine->intake_qty.' '.$p_medicine->dosage}}</td>
